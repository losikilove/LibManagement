        ...
        ButtonContinue.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    //If the balance which is after the transaction is less than the minimum balance,
                    //Show a notification
                ...
                //Decrease the number of borrowing books and set status of transaction to 'Borrowing'
                try {
                    String strTID = "";
                    connection = LibManagement.connect();
                    connection.setAutoCommit(false);
